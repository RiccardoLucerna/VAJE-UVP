...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDI0MywidXNlciI6MTA3NDh9:1uNs0D:DPmrKLBKfyJLibk8-WT7bcN4SAml0k1ETL7dve9b5KI"
        try:
            primeri = [
                (
                    "primer1a.py",
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDIwOSwidXNlciI6MTA3NDh9:1uNs0D:ebJ8Pp3UXC82UzvaeXnPn_ZVNhfnejqTV1wq_RZREjU"
        try:
            primeri = [
                (
                    "primer2a.py",
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDIxMCwidXNlciI6MTA3NDh9:1uNs0D:RC_RNjCMDKblmcw-XclRzKkzOup19OwKiffMEy35BuQ"
        try:
            primeri = [
                (
                    "primer3a.py",
