...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDIyNywidXNlciI6MTA3NDh9:1uNs0D:c7MqOcBdisJQe_Vw03ACbKE1f9gaRJymxgmxZzu7jd8"
        try:
            testi = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDIyOCwidXNlciI6MTA3NDh9:1uNs0D:6UWMyqMegVSjwG56L6Ovg70QaG8i3KscjIWrQpgAiVc"
        try:
            testi = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDIyOSwidXNlciI6MTA3NDh9:1uNs0D:UoY0A2bRYXn3fZiS6dL9ejZdUwZ0n0C2WrGDCvM9utM"
        try:
            testi = [
