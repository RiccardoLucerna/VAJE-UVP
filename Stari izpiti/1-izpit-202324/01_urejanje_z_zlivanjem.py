...
def uredi(sez):
    if len(sez) <= 1:
        return sez
    sredina = len(sez) // 2
    leva = uredi(sez[:sredina])
    desna = uredi(sez[sredina:])
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDE5NywidXNlciI6MTA3NDh9:1uNryp:i6Cb5L1AmErqQUiUL6mWojpAJ-sGme1kQ2xzg1dnxTo"
        try:
            tests = [
                ([1, 2, 3], [4, 5, 6], [1, 2, 3]),
                ([1], [2], [1]),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDE5OCwidXNlciI6MTA3NDh9:1uNryp:QuAOOk9qNEXiQhH56eOnoIR5G4fhduHqf7EbBvQbqOc"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDE5OSwidXNlciI6MTA3NDh9:1uNryp:9fuaREwdF-66KsWjeVDxFYLTQu7Xw6_tzBbx22Gy2aY"
        try:
            tests = (
