...
def najvecji_clen(n):
    if n == 1:
        return 1
    max_naslednji = najvecji_clen(naslednji_clen(n))
    if max_naslednji > n:
        return max_naslednji
    else:
        return n
# =====================================================================@000949=
# 4. podnaloga
...
def najdaljse_zaporedje(m, n):
    if m > n:
        return 0
    naj_preostanek = najdaljse_zaporedje(m + 1, n)
    dolzina_m = dolzina_zaporedja(m)
    if naj_preostanek > dolzina_m:
        return naj_preostanek
    else:
        return dolzina_m
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NDYsInVzZXIiOjEwNzQ4fQ:1u5mrm:c37Lqea2kFxC3Pu0baQgL-oWdcuLgjj_hqM79OKDCD4"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NDcsInVzZXIiOjEwNzQ4fQ:1u5mrm:krYrywcWd5orjNBW_dXNdityKpf-RSSc44iP-oEMUJ8"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NDgsInVzZXIiOjEwNzQ4fQ:1u5mrm:zFD5yJsGJgUMMK3OoB7ZFAOFR796adByim1TFZ7OGVY"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NDksInVzZXIiOjEwNzQ4fQ:1u5mrm:YRtiy9xWMUpAhx_TODKVXbfvbMpFBKVNaXelfkPhxVo"
        try:
