...
def ali_ima_enkratne_stevke(n):
    if n < 10:
        return True
    k = n % 10 #enice stevila n oziroma trenutna stevka
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDAyNSwidXNlciI6MTA3NDh9:1u5mrm:gwjTMSbKeNhvUtPZwLQyxd0DHDCbxlW77VlUzkc6Ngg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDAyNiwidXNlciI6MTA3NDh9:1u5mrm:BzpGd3TeU-i7E0Ru5AqAdzOGHyuQOt5PVH2-FCZ-q7I"
        try:
