...
def binomski_rekurzija(n, k):
    if k == 0:
        ...
        return binomski_fakulteta(n - 1, k) + binomski_rekurzija(n - 1, k - 1)
# =====================================================================@000952=
# 3. podnaloga
...
def binomski_ucinkovit(n, k):
    if k == 0:
        ...
        return int(((n - k + 1) / k) * binomski_ucinkovit(n, k - 1))
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTAsInVzZXIiOjEwNzQ4fQ:1u5mrm:3GiPK7L4mmlOaot_xhNKKN1ieLLHoxY2EOFm0fA499w"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTEsInVzZXIiOjEwNzQ4fQ:1u5mrm:SWkqIMtidRFO97bPZ0wVnJvVtI6NsRAQNucv19cPB80"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTIsInVzZXIiOjEwNzQ4fQ:1u5mrm:Vp44CNfkzw8PbGwKLz_Pv2a3E_XsdKWkS5xLvFWKElQ"
        try:
