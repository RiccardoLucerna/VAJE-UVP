...
# =============================================================================
def ugibaj(n):
    m = preberi_celo_stevilo()
    if m == n:
        print(f'BRAVO! Res sem si zamislil število {m}!')
    elif m < n:
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5NiwidXNlciI6MTA3NDh9:1u65BK:8rhfZrwYOmjDkCfYRJ_37KG7Cd3TL75v1VpFMiwn4Lg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5NywidXNlciI6MTA3NDh9:1u65BK:o16J5c9_WUS7W073nEx-w_VO_Gz-iHMM8v7xmC4XX58"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzYyMywidXNlciI6MTA3NDh9:1u65BK:UlnS9xGOblPGJthc1u6MDHcxEzv7-IVbgduFC0u2XcU"
        try:
