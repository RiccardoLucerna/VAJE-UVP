...
#     "cesta"
# =============================================================================
def odstrani_samoglasnike(s):
    if s[0] in "aeiouAEIOU":
        return odstrani_samoglasnike(s[1:])
    else:
        return s
# =====================================================================@027484=
# 4. podnaloga
...
#     ")))()3+4((("
# =============================================================================
def obrni_oklepaje(s):
    if s == "":
        return ""
    elif s[0] == "(":
        return ")" + obrni_oklepaje(s[1:])
    elif s[0] == ")":
        return "(" + obrni_oklepaje(s[1:])
    else:
        return s[0] +obrni_oklepaje(s[1:])
# =====================================================================@027485=
# 5. podnaloga
...
def prestej_posebno(s, c, k):
    if not s:
        ...
        return prestej_posebno(s[1:], c, k -  1)
    else:
        return prestej_posebno(s[1:], c, k)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5MSwidXNlciI6MTA3NDh9:1u65BK:6-kT5Q2ImPbL_0BdW1S-y-0VgFL-1zrvLgA_0IBjPo4"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5MiwidXNlciI6MTA3NDh9:1u65BK:P4Dl544xiH06tJoGzIPFY8blVoasnj_jVLIvTi1uKSs"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ4MywidXNlciI6MTA3NDh9:1u65BK:yhggid0QyaLh74yC6b2reNFRlNxDVT0-pLzoJ1GqMS4"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ4NCwidXNlciI6MTA3NDh9:1u65BK:H07z5y-l5eleB_qY4qePWxclYZOAHvRvhr0ZuXqHNcI"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ4NSwidXNlciI6MTA3NDh9:1u65BK:DjorVLC_vT3xGJhVHJeeTqbnQ7_cB-hGKxNRlRiE_2E"
        try:
