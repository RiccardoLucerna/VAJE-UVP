...
def je_prestopno(leto):
    ...
    if ostanek1 == 0:
        return True
    elif ostanek3 == 0 and ostanek2 != 0:
        return True
    else:
        return False
# =====================================================================@000928=
...
def je_veljaven_datum(dan, mesec, leto):
    return (mesec == 1 or mesec == 2 or mesec == 3 or mesec == 4 or mesec == 5 or mesec == 6 or mesec == 7 or mesec == 8 or mesec == 9 or mesec == 10 or mesec == 11 or mesec == 12) and dan <= stevilo_dni(mesec,leto) and dan > 0
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjcsInVzZXIiOjEwNzQ4fQ:1u5mNx:W3aC5aB7MbXeGXhdCkA0nXuGKmCKgzVki711wiT-bQQ"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjgsInVzZXIiOjEwNzQ4fQ:1u5mNx:Q6X4Qbc2uNDX8qNfyW2A4GsZKdV6qRwJdUjDCzQE7aY"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjksInVzZXIiOjEwNzQ4fQ:1u5mNx:JjPJBDMMBIz0fWJyaJtaD9glZYvbWmxYXm3Khmp9KZo"
        try:
