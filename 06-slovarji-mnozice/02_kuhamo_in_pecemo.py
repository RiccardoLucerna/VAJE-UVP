...
def kaj_moramo_se_kupiti(recept, shramba):
    ...
    for kljuc in recept:
        if kljuc in shramba:
            if recept[kljuc] > shramba[kljuc]:
                nakup[kljuc] = recept[kljuc] - shramba[kljuc]
        else:
            nakup[kljuc] = recept[kljuc]
    return nakup
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzkyLCJ1c2VyIjoxMDc0OH0:1uMtLR:_zjPuLENiJerVtKwz9EbLqBrhBSxlwZOicWIsaSb630"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzkzLCJ1c2VyIjoxMDc0OH0:1uMtLR:5WgbKto3MfNGMGqZKfF7MJxiYaoEii41QmlQSVqp6TE"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzk0LCJ1c2VyIjoxMDc0OH0:1uMtLR:cJJE56DUXLr0tBJGluA2YYfIb5Vt_ezlMAxRLOqcncQ"
        try:
