...
#     {'pita': 1}
# =============================================================================
def nakupovalni_seznam(slo, sez):
    sladice = {}
    for ime in sez:
        if ime in slo:
            naj_sladica = slo[ime]
            if naj_sladica in sladice:
                sladice[naj_sladica] += 1
            else:
                sladice[naj_sladica] = 1
    return sladice
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDMzNywidXNlciI6MTA3NDh9:1uMtLR:aVs9i1IxElSnTCmzzSQ4PsVR955iUt4tsrKQoz7Hetw"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDMzOCwidXNlciI6MTA3NDh9:1uMtLR:l9eg-88KPaGHUEa6NgtEZDS0lyahRA9Y4zC_79fHGLQ"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDMzOSwidXNlciI6MTA3NDh9:1uMtLR:jshTniaHFUTCp9jJRGpQ0_d570MQjb8-2KQt4Zn4lR0"
        try:
