...
def sifriraj(sifra, beseda):
    nova_beseda = ""
    for znak in beseda:
        nova_beseda = nova_beseda + sifra[znak]
    return nova_beseda
# =====================================================================@001389=
# 2. podnaloga
...
def ali_je_sifra(sifra):
        return set(sifra.values()) == set(sifra)
# =====================================================================@001390=
# 3. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzg4LCJ1c2VyIjoxMDc0OH0:1uMtLR:mW4072bft9-g4VryYZSzIZnxb91Iu087KoI-8qqv38k"
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzg5LCJ1c2VyIjoxMDc0OH0:1uMtLR:wbfsG03zogp6VK7wdmchSmymCqwUQK0JKiD5woblIEQ"
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzkwLCJ1c2VyIjoxMDc0OH0:1uMtLR:8bjav4VYw0vfm83QOyUXMJeONSuELG3y6YpRNqs_lUQ"
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzkxLCJ1c2VyIjoxMDc0OH0:1uMtLR:R42Fla-sm_iw1VS6CFTTwPwiGz9VtswB49vgwUY7HIw"
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
