...
def cikli(perm):
    ...
    for i in sorted(perm):
        if i not in mnoz:
            sez.append(cikel(perm, i))
            mnoz.update(cikel(perm, i))
    return sez
# =====================================================================@001383=
# 5. podnaloga
...
#     False
# =============================================================================
def je_permutacija(perm):
    return set(perm.values()) == set(perm) and len(set(perm)) == max(perm)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzc5LCJ1c2VyIjoxMDc0OH0:1uMtLR:2y6m0u1Dr4xB4K5z3OjPj1aWt_BNYhIM-hDeABnG-BY"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzgwLCJ1c2VyIjoxMDc0OH0:1uMtLR:ANU5yx5u2Ci-udBLP7efoQnJyoOI3SLBRgn6qzMFE4s"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzgxLCJ1c2VyIjoxMDc0OH0:1uMtLR:J1Kjjekw5Q0g_4bTgzUpjdvNM7_lq34ggba69u-S0Zs"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzgyLCJ1c2VyIjoxMDc0OH0:1uMtLR:uh8Q6TakZL_esPXdAfqdvBxBxzYdFHcWn6f8WTHPGr0"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzgzLCJ1c2VyIjoxMDc0OH0:1uMtLR:JbYy2_EdAyof_BcR4Ml1eTYf83_dD9iuzZXvJQoCxjg"
        try:
