...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzgxMywidXNlciI6MTA3NDh9:1u3HLB:olh42-tGjr2uU1KXjDCs1VUiUgkJ2Pn395LSOFdeuWw"
        try:
            svet_1 = [
                [False, False, False, False, False, False],
                [False, False, False, True, False, False],
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzgxNCwidXNlciI6MTA3NDh9:1u3HLB:LVZFHOuQ_6FDue5yUGoYs5L1CadVsABoyYlvYc0qlmE"
        try:
            svet_1 = [
                [False, False, False, False, False, False],
                [False, False, False, True, False, False],
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzgxNSwidXNlciI6MTA3NDh9:1u3HLB:2Xt_wN9M1fEKvy-_JBE56Y3FZUYOA8JjvF7cyh4lMT4"
        try:
            svet_1 = [
                [False, False, False, False, False, False],
                [False, False, False, True, False, False],
