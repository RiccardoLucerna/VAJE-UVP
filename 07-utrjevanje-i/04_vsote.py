...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNDc0LCJ1c2VyIjoxMDc0OH0:1u3HLB:PE6tIqc7QRHyKrtHZdVa2-YHSMGxkHl4TMaNOE64FXM"
        try:
            test_data = [
                ("""vsota_kvadratov(1)""", 1),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNDc1LCJ1c2VyIjoxMDc0OH0:1u3HLB:YbleRqIt9ksv84NnyvelBpxoWSwFdbN-iFcQCKA3WM0"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNDc2LCJ1c2VyIjoxMDc0OH0:1u3HLB:NM3h8LirW0134H26oCmUW5X2rTZdrzuIaOtvS7P_RP0"
        try:
            test_data = [
                ("""stevilo_clenov(2)""", 1),
                ("""stevilo_clenov(19)""", 2),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNDc3LCJ1c2VyIjoxMDc0OH0:1u3HLB:4mpHbx20Bgb4Bz8jFnf1haWkHv1BP8RHsem_W1xqRHk"
        try:
            test_data = [
